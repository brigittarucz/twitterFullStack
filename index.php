...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;900;700&display=swap" rel="stylesheet">
</head>
...
<body>
  ...
  <div id="page">
    ...
    <div id="left">
      <a href="/home" onclick="changeView(); return false;" class="active">
      ...
      <a href="/explore" onclick="changeView(); return false;">
      ...
      <a href="/notifications" onclick="changeView(); return false;">
        <svg viewBox="0 0 24 24">
          <path
        ...
        Notifications</a>
      <a href="/messages" onclick="changeView(); return false;">
        <svg viewBox="0 0 24 24">
          <path
        ...
        Messages</a>
      <a href="/bookmarks" onclick="changeView(); return false;">
        <svg viewBox="0 0 24 24">
          <path
        ...
        Bookmarks</a>
      <a href="/lists" onclick="changeView(); return false;">
        <svg viewBox="0 0 24 24">
          <path
        ...
        Lists</a>
      <a href="/profile" onclick="changeView(); return false;">
        <svg viewBox="0 0 24 24">
          <path
        ...
        Profile</a>
      <a href="/more" onclick="changeView(); return false;">
        <svg viewBox="0 0 24 24">
          <path
        ...
        More</a>
      <button class="btn btn-tweet" onclick="openModal()" data-queryElement="#modal-tweet">
        Tweet
      </button>
      <div id="popup-logout" onclick="closePopup(); return false;" data-queryElement="#popup-logout">
        <div class="popup-logout_content">
          <div>
            <svg viewBox="0 0 24 24" class="r-9uu7rm r-jwli3a r-4qtqp9 r-yyyyoo r-2pyi3h r-n6v787 r-1xvli5t r-dnmrzs r-u8s1d r-1plcrui r-uoibet r-lrvibr r-lrsllp" style="left: calc(17.5px);"><g><path d="M12.538 6.478c-.14-.146-.335-.228-.538-.228s-.396.082-.538.228l-9.252 9.53c-.21.217-.27.538-.152.815.117.277.39.458.69.458h18.5c.302 0 .573-.18.69-.457.118-.277.058-.598-.152-.814l-9.248-9.532z"></path></g></svg>
          </div>
          <div>
            <a href="views/authentication.php">Logout @brigitta</a>
          </div>
        </div>
      </div>
    ...
    <div id="middle">
      ...
      <div class="view" id="middle-home">
        ...
        <section id="middle_posts-section">
          <article class="post-article">
            ...
            <div>
              <h5>TIME <span class="post-following">
                  <svg viewBox="0 0 24 24">
                    <g>
                      <path
                  ...
                  </svg></span> <span class="post-at">@Time</span> <span class="post-time">&#8226; 31s</span> <a
                  href="/" class="post-action"> <svg viewBox="0 0 24 24"
            ...
            <div>
              <p>Make things easier for your users. <a href="" class="post-tag">@jasonaten</a></p>
            </div>
      ...
      <div class="view" id="middle-profile">
        <section id="middle_header-section">
          ...
          <div>
            <h3 class="text-lg-dark-900">Brigitta Rucz</h3>
            <p class="text-sm">3 Tweets</p>
          </div>
        </section>
        <section id="middle_profile-section">
          <div>
            <img class="cover-img" src="media/cover.jpg" alt="">
          </div>
          <div>
            <img class="profile-img" src="media/profile.jpg" alt="">
            <button class="btn btn-reverse">Edit profile</button>
          </div>
          <article>
            <h3 class="text-lg-dark-900">Brigitta Rucz</h3>
            <p class="text-sm">@BrigittaRucz</p>
            <p class="user-joined"><svg viewBox="0 0 24 24"
                class="r-1re7ezh r-4qtqp9 r-yyyyoo r-1xvli5t r-7o8qx1 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr">
                <g>
                  <path
              ...
              </svg> Joined September 2019</p>
            <div class="user-statistics">
              <p class="user-following text-sm"><span class="text-sm-dark user-following-number">53</span>Following</p>
              <p class="user-followers text-sm"><span class="text-sm-dark user-followers-number">1</span>Followers</p>
            </div>
          </article>
        </section>
        <section id="middle_action-section">
          <a href="/" class="btn-link text-md-light-600 btn-link-active">Tweets</a>
          <a href="/" class="btn-link text-md-light-600">Tweets & replies</a>
          <a href="/" class="btn-link text-md-light-600">Media</a>
          <a href="/" class="btn-link text-md-light-600">Likes</a>
        </section>
        <section id="middle_action-tweets">
          <div class="retweet">
            <div>
              <svg viewBox="0 0 24 24"
            ...
            <article class="post-article">
              ...
              <div>
                <h5>TIME <span class="post-at">@Time</span> <span class="post-time">&#8226; 31s</span> <a href="/"
                    class="post-action"> <svg viewBox="0 0 24 24"
                      class="r-4qtqp9 r-yyyyoo r-ip8ujx r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-27tl0q">
                      <g>
                        <path
                          d="M20.207 8.147c-.39-.39-1.023-.39-1.414 0L12 14.94 5.207 8.147c-.39-.39-1.023-.39-1.414 0-.39.39-.39 1.023 0 1.414l7.5 7.5c.195.196.45.294.707.294s.512-.098.707-.293l7.5-7.5c.39-.39.39-1.022 0-1.413z">
              ...
              <div>
                <p>Make things easier for your users. <span class="post-tag">@jasonaten</span></p>
              </div>
              <div class="post-article_link">
                <img src="media/link.jpg" alt="">
                <p class="title-link">Repeat prescriptions—does the global economy need a new diagnosis?</p>
    ...
    <div id="right">
      <section id="right_search-section">
        <div>
          <svg viewBox="0 0 24 24"
      ...
      <section id="right_trends-section">
        <div>
          <h3 class="text-lg-dark-900">Trends for you</h3>
          <a href="/">
            <svg viewBox="0 0 24 24"
              class="r-13gxpu9 r-4qtqp9 r-yyyyoo r-1q142lx r-50lct3 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1srniue">
              <g>

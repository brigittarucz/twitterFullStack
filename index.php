...
<body>
  ...
  <div id="page">
    ...
    <div id="left">
      ...
      <div id="popup-logout" onclick="closePopup(); return false;" data-queryElement="#popup-logout">
        <div class="popup-logout_content">
          <div>
            <svg viewBox="0 0 24 24"
              class="r-9uu7rm r-jwli3a r-4qtqp9 r-yyyyoo r-2pyi3h r-n6v787 r-1xvli5t r-dnmrzs r-u8s1d r-1plcrui r-uoibet r-lrvibr r-lrsllp"
              style="left: calc(17.5px);">
              <g>
                <path
    ...
    <div id="middle">
      ...
      <div id="popup-post" onclick="closePopup(); return false;" data-queryElement="#popup-post">
        <div class="popup-post_content">
          <div>
            <svg viewBox="0 0 24 24"
              class="r-9uu7rm r-jwli3a r-4qtqp9 r-yyyyoo r-2pyi3h r-n6v787 r-1xvli5t r-dnmrzs r-u8s1d r-1plcrui r-uoibet r-lrvibr r-lrsllp"
              style="left: calc(17.5px);">
    ...
    <div class="modal-tweet_content">
      <form id="formTweet" onsubmit="createTweet(); return false;">
        ...
        <div class="tweet-controls">
          ...
          <button type="submit" data-queryElement="#modal-tweet" onclick="closeModal();"
            class="btn btn-tweet">Tweet</button>
        </div>
      </form>
    </div>
  </div>
